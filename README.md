...
Code Red is an informative and robust web application that highlights air pollution in neighbourhoods across Canada that suffer from inequality. The goal of this application is to identify hotspots for environmental racism (test change - is this what we want to say? more than race -> environmental racism and other forms of environmental inequalities? )that require priority attention. 
